...
const DashBoard = () => {
  ...
  return (
    <>
      <div className="bg-gray-200 top-0 py-2 font-bold text-2xl ">
        <img
          className="px-8 w-1/12 inline-block"
          src="https://upload.wikimedia.org/wikipedia/commons/9/9a/BTC_Logo.svg"
        />
        BITCOIN STOCK PRICE MONITORING DASHBORD
      </div>
      {/* LEFT SIDE BAR-------------------------------------------------------- */}
      ...
      {/* -----------------------------CHARTS------------------------- */}
      <div className=" xl:pl-20 pl-60 mt-16   flex justify-center flex-col xl:flex-row ">
        <Chart datas={datas} />

        <BtcBarChart datas={datas} />
      </div>
    </>
  );
};
